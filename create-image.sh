...
sudo chroot $DIR /bin/bash -c "apt-get update && apt-get install -y gnupg2"

sudo chroot $DIR /bin/bash -c "echo deb https://mirrors.tuna.tsinghua.edu.cn/ubuntu/ focal main restricted universe multiverse >> /etc/apt/sources.list"
sudo chroot $DIR /bin/bash -c "echo deb https://mirrors.tuna.tsinghua.edu.cn/ubuntu/ focal-updates main restricted universe multiverse >> /etc/apt/sources.list"
sudo chroot $DIR /bin/bash -c "echo deb https://mirrors.tuna.tsinghua.edu.cn/ubuntu/ focal-backports main restricted universe multiverse >> /etc/apt/sources.list"
sudo chroot $DIR /bin/bash -c "echo deb https://mirrors.tuna.tsinghua.edu.cn/ubuntu/ focal-security main restricted universe multiverse >> /etc/apt/sources.list"


#sudo chroot $DIR /bin/bash -c "sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 3B4FE6ACC0B21F32
#                              sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 871920D1991BC93C"


# sudo chroot $DIR /bin/bash -c "apt-get update; apt-get install -y software-properties-common"

# sudo chroot $DIR /bin/bash -c "sed -i 's/isAlive\(\)/is_alive/g' /usr/lib/python3/dist-packages/softwareproperties/SoftwareProperties.py"
